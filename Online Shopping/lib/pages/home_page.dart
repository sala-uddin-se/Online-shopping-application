...
import 'package:ruf5/models/data_model.dart';
import 'package:ruf5/pages/add_edit_product.dart';
import 'package:ruf5/services/db_service.dart';
import 'package:ruf5/utils/form_helper.dart';
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Porduct List",style: TextStyle(fontSize: 22,color: Colors.black,fontWeight: FontWeight.bold)),
      ),
      body: _fetchData(),
    );
  }
